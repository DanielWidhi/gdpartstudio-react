        ...
        <div className="bg-background-light dark:bg-background-dark font-display min-h-screen flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-[480px] bg-white dark:bg-[#1a202c] rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-100 dark:border-gray-800 transition-all">
                ...
                <div className="relative h-32 bg-primary/5 flex items-center justify-center overflow-hidden">
                    <div className="absolute inset-0 bg-cover bg-center opacity-30" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAb0GTy5B4zH7fH6D1zeSRs-VKmtWx9V4sg4eiMTAWT7AfuZQ1pdkoSn-d-bBZgLfLWlJLF3ciZ5FAbaWEIWG6bapFWs8k_J7T_m53aWxQG2-Zaqv6smz8hMz8XEaHcDJw4loZORm9D90IUoiRbPBNDO33hzk-bil0zlHvrz4DoibL2QOi_4EXsDWzV_9CSfE6yX2jkiqaMWv1i-4JnXIYSFjpoxWjWM4GhZ389N1l7s0jgSfFKbVaxtmimkFJCcq_rKZ6jmt3wNsY')" }}></div>
                    ...
                    <form className="flex flex-col gap-5" onSubmit={handleLogin}>
                        <div className="flex flex-col gap-1.5">
                            ...
                            <div className="relative">
                                <input className="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 text-base placeholder:text-slate-400 transition-colors" id="email" placeholder="admin@gdpartstudio.com" type="email" />
                        ...
                        <div className="flex flex-col gap-1.5">
                            <div className="flex justify-between items-center">
                                ...
                                <a className="text-primary hover:text-primary/80 text-xs font-semibold" href="#">Forgot Password?</a>
                            </div>
                            <div className="relative group">
                                <input className="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 pr-12 text-base placeholder:text-slate-400 transition-colors" id="password" placeholder="Enter your password" type="password" />
                ...
                <div className="bg-slate-50 dark:bg-slate-800/50 p-4 border-t border-slate-100 dark:border-slate-700 text-center">
                    <p className="text-slate-400 dark:text-slate-500 text-xs font-medium">
                        © 2024 GDPARTSTUDIO. All rights reserved.
                    </p>
                </div>
            </div>
            <div className="mt-8">
